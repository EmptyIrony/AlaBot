 ...
 */
@Getter
public class UpHelper extends JcqAppAbstract implements ICQVer, IMsg, IRequest {
    ...
    public static void main(String[] args) {
        ...
        // 要测试主类就先实例化一个主类对象
        UpHelper upHelper = new UpHelper();
        // 获取当前酷Q操作对象
        CoolQ CQ = upHelper.getCoolQ();
    ...
    public String appInfo() {
        ...
        String AppID = "me.cunzai.uphelper";// 记住编译后的文件和json也要使用appid做文件名
        /**
    ...
    public int enable() {
        ...
        this.httpAsyncClient = HttpAsyncClients
                .custom()
    ...
    private Registry<SchemeIOSessionStrategy> getSSLRegistryAsync() {
    ...
    private PoolingNHttpClientConnectionManager getPoolingNHttpClientConnectionManager() {
        try {
